...
;(function($, window, document, undefined) {
	...
	Tree.prototype = {
		...
		_template: {
			...
			link: '<a href="#" style="color:inherit;" target="main_frame"></a>',
			badge: '<span class="badge"></span>'
		},

		_css: '.treeview .list-group-item{cursor:pointer}.treeview span.indent{margin-left:5px;margin-right:5px}.treeview span.expand-collapse{width:1rem;height:1rem}.treeview span.icon{margin-left:5px;margin-right:5px}'
